...
def menu_view(request):
    # example food list
    foods = [
        {'name': 'Burger', 'image': 'menu/burger.png'},
        {'name': 'Pizza', 'image': 'menu/pizza.png'},
        {'name': 'Rice', 'image': 'menu/rice.png'},
        # add up to 12 ...
    ]
...
def admin_view(request):
    # team members list
    team = [
        {'name': 'Abi', 'role': 'Head Chef', 'image': 'team/abi.jpeg'},
        {'name': 'Dhruv', 'role': 'Manager', 'image': 'team/dhruv.png'},
        # add 4 more ...
    ]
